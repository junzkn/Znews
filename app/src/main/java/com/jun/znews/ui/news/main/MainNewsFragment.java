...
import com.jun.znews.ui.news.newsFragment.NewsFragment;
import com.jun.znews.ui.news.channel.ChannelDialogFragment;
...
public class MainNewsFragment extends Fragment implements IMainNewsView {
    ...
    private IMainNewsPresenter mPresenter ;
    ...
    private class mPagerChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            ...
            activity.getDrag_layout().setDrag(position==0);
        }
        @Override
