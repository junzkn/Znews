...
import com.jun.znews.ui.news.model.MainNewsModel;
...
public class MainNewsPresenter extends BasePresenter<IMainNewsContarct.IMainNewsView,IMainNewsContarct.IMainNewsModel> implements IMainNewsContarct.IMainNewsPresenter {

    public MainNewsPresenter(IMainNewsContarct.IMainNewsView mView) {
        super(mView);
    }

    @Override
    protected IMainNewsContarct.IMainNewsModel createModel() {
        return new MainNewsModel();
    }
